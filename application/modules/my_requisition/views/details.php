            ...
            <div class="grid simple horizontal">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     <a href="<?=base_url('my_requisition')?>" class="btn btn-info btn-xs btn-mini"> My Requisition List</a>
                  </div>
               </div>
               ...
               <div class="grid-body"  id="printableArea">
                  ...
                  <div class="row form-row">
                     ...
                     <div class="col-md-12">
                        <div class="pull-right">
                           <?php if($userDetails['user_info']->id==$info->user_id) { ?>
                           <a class="btn btn-primary btn-cons" href="<?= base_url('my_requisition') ?>">Back</a>
                           <?php } else { ?>
                           <a class="btn btn-primary btn-cons" href="<?= base_url('requisition') ?>">Back</a>
                           <?php } ?>
                        </div>
                     </div>
                  </div>
