        ...
        <div class="priview-demand">
            ...
            <table class="tg" width="100%">
                <tr>
                    ...
                    <td colspan='5' class="tg-ywa9"><?=$info->supplier_name?></td>
                </tr>
                <tr>
                ...
                <tbody>
                    <?php $sl=0;
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?=$item->pur_quantity?></td>
                            <td class="text-right"><?=$item->pur_approve?></td>
                            <td class="text-left"><?=$item->pur_remark?></td>
                        </tr>
                    <?php } ?>
                </tbody>
