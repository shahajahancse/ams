            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">
                     <a href="<?=base_url('general_setting/asset_rooms')?>" class="btn btn-info btn-xs btn-mini"> Asset Rooms List</a>
                  </div>
               </div>
               <div class="grid-body">
                  ...
                  <div class="row form-row">
                     <div class="col-md-6">
                        ...
                        <input name="room_name" type="text" value="<?=set_value('room_name', $info->room_name)?>" class="form-control input-sm" placeholder="">
                     </div>
                     <div class="col-md-6">
