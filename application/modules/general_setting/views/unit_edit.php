          ...
          <div class="grid simple horizontal">
             <div class="grid-title">
              ...
              <div class="pull-right">
                <a href="<?=base_url('general_setting/units')?>" class="btn btn-info btn-xs btn-mini">List</a>
              </div>
             </div>
             <div class="grid-body">
              ...
              <div class="row form-row">
                ...
                <div class="col-md-4">
                  ...
                  <select name="type" id="type" class="form-control input-sm" id="">
                    ...
                    <option value="1" <?=$info->type=='1'?'selected':'';?>>Director Office</option>
              ...
              <div class="row form-row">
                <div class="col-md-6">
                  ...
                  <input name="address_bn" id="address_bn" type="text" value="<?=set_value('address_bn', $info->address_bn)?>" class="form-control input-sm" placeholder="">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Address English <span style="color:red">*</span></label>
                  <?php echo form_error('address_en'); ?>
                  <input name="address_en" id="address_en" type="text" value="<?=set_value('address_en', $info->address_en)?>" class="form-control input-sm" placeholder="">
                </div>
              </div>
