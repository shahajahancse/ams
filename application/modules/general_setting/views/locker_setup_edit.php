       ...
       <div class="col-md-9">
          <div class="grid simple horizontal">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("general_setting/locker_setup_edit/".$info->id, $attributes);?>

              <div class="row form-row">
                <div class="col-md-6">
                  <label class="form-label">Name Bangla <span style="color:red">*</span></label>
                  <?php echo form_error('name_bn'); ?>
                  <input name="name_bn" value="<?=$info->name_bn?>" class="form-control input-sm" placeholder="">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Name English <span style="color:red">*</span></label>
                  <?php echo form_error('name_en'); ?>
                  <input name="name_en" value="<?=$info->name_en?>" class="form-control input-sm" placeholder="">
                </div>
              </div>
              ...
              <div class="row form-row">
                ...
                <div class="col-md-6">
                  ...
                  <select name="room_id" class="form-control input-sm">
                    <option value="">select one</option>
                    <?php foreach ($rooms as $key => $r) { ?>
                      <option <?= $info->room_id==$r->id? 'selected':'' ?> value="<?= $r->id ?>"><?= $r->name_en ?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class="col-md-6">
