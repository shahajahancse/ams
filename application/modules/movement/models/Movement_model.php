...
class Movement_model extends CI_Model {
    ...
    public function get_all_movements() {
        $this->db->select('am.*, i.item_name, u_from.first_name as from_custodian_fname, u_from.last_name as from_custodian_lname, u_to.first_name as to_custodian_fname, u_to.last_name as to_custodian_lname, u_created.first_name as created_by_fname, u_created.last_name as created_by_lname');
