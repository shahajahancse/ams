             ...
             <div class="grid-body">
              ...
              <div class="row form-row">
                <div class="col-md-6">
                  ...
                  <input name="sl" id="sl" type="number" class="form-control input-sm" placeholder="SL" min="1" required oninput="this.value = Math.max(this.value, 1);" onkeyup="this.value = (this.value > 0) ? this.value : 1;">
                </div>
                <div class="col-md-6">
